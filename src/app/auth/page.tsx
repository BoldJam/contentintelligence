        ...
        <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="space-y-4">
                    {/* Google SSO Button */}
                    <button
                        className="w-full bg-white text-black hover:bg-gray-100 transition-colors font-semibold py-3 px-4 rounded-xl flex items-center justify-center gap-3"
                    ...
                    <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-[#0f172a] px-4 text-sm text-gray-500">or continue with email</span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <button className="w-full bg-primary/10 text-primary hover:bg-primary/20 border border-primary/20 transition-all font-semibold py-3 px-4 rounded-xl">
                            Continue with Email
                        </button>
                    </div>
                </div>
